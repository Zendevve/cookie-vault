...
- Should ideally support the legacy SJCL format for backward compatibility if possible, or migrate to Web Crypto API (AES-GCM) for new backups. *Decision: Support import of legacy SJCL, use Web Crypto for new backups.*
